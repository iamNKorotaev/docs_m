...
* [Установка](start/install.md)
* [Конфигурация](start/env.md)

## Документация <a href="#docs" id="docs"></a>

* [Настройки хоста](docs/host-settings.md)
* [Настройка узла](docs/node-settings.md)
* [CLI](docs/cli.md)
* [API](docs/api.md)
...
* [Marzban Новости](https://t.me/Gozargah\_news)
* [Marzban Комьюнити](https://t.me/gozargah\_marzban)
